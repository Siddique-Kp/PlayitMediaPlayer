...
class VideoFavouriteAdapter extends TypeAdapter<VideoFavourite> {
  @override
  final int typeId = 2;

  @override
  VideoFavourite read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, VideoFavourite obj) {
    writer
      ..writeByte(4)
      ..writeByte(0)
      ..write(obj.index)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is VideoFavouriteAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
